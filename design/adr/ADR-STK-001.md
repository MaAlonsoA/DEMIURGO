...
- Comprobación: Se revisa la configuración de TypeScript y se ejecuta `pnpm gate:types`.
...
- Verificación: automática
- Comprobación: Se revisan las dependencias directas de todos los `package.json` del monorepo.
...
- Verificación: automática
- Comprobación: Una prueba de integración inspecciona la base con el sistema arrancado.
...
- Verificación: automática
- Comprobación: Se revisan los imports de `packages/domain/src`.
