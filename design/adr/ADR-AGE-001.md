...
codigo: ADR-AGE-001
tipo: adr
titulo: Agentes por CLI con suscripción
version: 1
estado: propuesto
dominio: plataforma
incremento: S0
...
- Comprobación: Se revisan los argumentos y el entorno con los que el adaptador lanza la CLI.
...
- Verificación: automática
- Comprobación: Se normalizan salidas JSON grabadas de la CLI, de éxito y de error.
...
- Verificación: automática
- Comprobación: Se lanza un proceso que no termina y se deja vencer el tiempo o se aborta la señal.
