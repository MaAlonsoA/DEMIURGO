...
const select =
  'h-8 min-w-0 rounded-[var(--radius-control)] border border-line-strong bg-surface px-2 text-[13px] text-ink focus:border-needs focus:outline-none disabled:opacity-45';
