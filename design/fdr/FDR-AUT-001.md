...
- Comprobación: Se importa `design/` y se comparan los recuentos del lote con los del origen.
...
- Verificación: automática
- Comprobación: Se intenta ratificar el lote con cada tipo de actor no humano.
...
- Verificación: automática
- Comprobación: Se exporta tras ratificar y se compara con `design/` byte a byte.
...
- Verificación: automática
- Comprobación: Se importa `design/` otra vez tras ratificar y se comparan los recuentos.
...
- Verificación: manual
- Comprobación: La persona ratifica la importación en su instancia de la v2 y revisa el resultado.
